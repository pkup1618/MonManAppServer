...
import components.database_handling.DBHandler;
import components.database_handling.JpaDBHandler;
import components.support_classes.*;
...
public abstract class ParentServlet extends HttpServlet {
    ...
    protected final DBHandler databaseHandler = JpaDBHandler.getInstance();
    protected final JsonSerializer jsonSerializer = JacksonJsonSerializer.getInstance();
    ...
    /**
     * устанавливает значение полю {@link Date} из строки в формате yyyy-MM-dd
